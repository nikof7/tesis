...
[En este anexo se pueden visualizar todos los gráficos.](anexo1)
...
map(categories, function(col) {
  ...
  watson_result$statistic
  
  
  # Almacenar resultados en la lista
  results_list[[length(results_list) + 1]] <<- data.frame(sp = sp_name, 
                                       cat = col, 
                                       dhat_1 = overlap_01[1],
                                       dhat_4 = overlap_01[2],
...
```{r}
# LOAD RESULTS_LIST y MOSTRAR RESULTADOS.
```
